...
<div class="container-fluid">
    ...
    <form action="{{route('author.product.store')}}" method="Post" enctype="multipart/form-data">
        @csrf
    <!-- Vertical Layout -->
            ...
            <div class="card">
                ...
                <div class="body">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="name" class="form-control" placeholder="Prduct name" name="title">
                            </div>
                        </div>
